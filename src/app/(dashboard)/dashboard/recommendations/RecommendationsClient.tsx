...
export default function RecommendationsClient({brands:initialBrands}:{brands:Brand[]}){
  const [brands,setBrands]=useState(initialBrands)
  const [selectedBrand,setSelectedBrand]=useState<Brand|null>(initialBrands[0]||null)
